# -*- coding: utf-8 -*-
# Generated by Django 1.11.14 on 2018-08-21 14:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='reporter',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='cirs.Reporter', verbose_name='Reporter'),
        ),
        migrations.AddField(
            model_name='organization',
            name='reviewers',
            field=models.ManyToManyField(to='cirs.Reviewer', verbose_name='Reviewers'),
        ),
    ]
